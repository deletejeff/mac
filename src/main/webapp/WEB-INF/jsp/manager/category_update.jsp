...
<form class="am-form" action="<%=path%>/category/update.do" method="post" data-am-validator>
    ...
    <div class="am-form-group">
        ...
        <input type="text" id="categoryId" name="categoryId" value="${categoryVo.categoryId}" readonly>
    </div>
    <div class="am-form-group">
        <label for="categoryName">名称</label>
        <input type="text" id="categoryName" name="categoryName" value="${categoryVo.categoryName}" required>
    </div>
    <div class="am-form-group">
        <label for="categoryOrder">排列顺序</label>
        <input type="number" id="categoryOrder" name="categoryOrder" value="${categoryVo.categoryOrder}">
    </div>
