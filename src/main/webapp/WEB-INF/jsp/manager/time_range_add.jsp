...
<form class="am-form" action="<%=path%>/time_range/add.do" method="post" data-am-validator>
    ...
    <div class="am-form-group">
        <button type="button" class="am-btn am-btn-default am-margin-right" id="startTime" name="startTime">开始时间</button>
        <span id="my-startDate"></span>
    </div>
    <div class="am-form-group">
        <button type="button" class="am-btn am-btn-default am-margin-right" id="endTime" name="endTime">结束时间</button>
...
<script type="application/javascript">
    $(function() {
        ...
        $('#startTime').datetimepicker({
            ...
            $('#my-startDate').text($('#startTime').data('date'));
        });
        $('#endTime').datetimepicker({
            ...
            $('#my-endDate').text($('#endTime').data('date'));
        });
    });
